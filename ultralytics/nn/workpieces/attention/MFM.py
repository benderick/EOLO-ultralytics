...
class MFM(nn.Module):
    style = "l"
    def __init__(self, inc, dim, ph=None, reduction=8, *args):
...
if __name__ == "__main__":
    model = MFM([3,16], 19)
    input_tensor1 = torch.randn(1, 3, 128, 128)
    input_tensor2 = torch.randn(1, 16, 128, 128)
    output_tensor = model([input_tensor1, input_tensor2])
    print("input",input_tensor1.shape)
